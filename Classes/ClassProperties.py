"""
To use simply import ClassProperty by copying ClassPropertyMeta and ClassProperty into your project.
1) Assign the metaclass to your class (IMPORTANT!)
2) Use as if its a normal @property
```
from thisFile import ClassProperty
class YourClass(metaclass=ClassProperty.meta):
    @ClassProperty
    def foo(cls):
       return cls._foo
